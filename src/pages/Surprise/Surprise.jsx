...
const Surprise = (props) => {
  ...
  const addClick = async () => {
    if (updateData) {
      //To make sure that isn't updating without sync before
    ...
    return (
      <div>
        ...
        <section className="clicker">
          ...
          <button className="button-19" onClick={addClick}>
            Click me!
          </button>
        </section>
        <section>
    ...
    <Fragment>
      {uid ? (
        ...
        <h2 className="warningNotLogged">
          Lo sentimos, es un espacio para los usuarios del sitio web, le rogamos
          que inicie sesión o se haga una cuenta nueva para ver esta página de
          sorpresa.
        </h2>
      )}
    </Fragment>
